...
const LendingPage: React.FC = () => {
  ...
  --------------------------------------------------------------- */
  return (
    <main className="relative max-w-6xl mx-auto p-6 sm:p-8 md:p-10 rounded-2xl overflow-hidden text-white bg-gradient-to-br from-indigo-800 via-blue-900 to-purple-900 shadow-2xl shadow-indigo-900/20 mt-8">
